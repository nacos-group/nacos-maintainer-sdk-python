...
A reference FastAPI service that demonstrates how to integrate [Nacos](https://nacos.io/) for configuration and service discovery together with the MCP (Model Context Protocol) ecosystem. The project is managed with [PDM](https://pdm.fming.dev/) and targets Python 3.13.
...
## Preparing Nacos
1. Upload the sample configuration `nacos-fastapi-mcp-example.yaml` to the Nacos Config Service.
