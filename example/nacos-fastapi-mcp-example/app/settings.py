...
APP_NAME = os.getenv("APP_NAME", "nacos-fastapi-mcp-example")
...
NACOS_DATA_ID = os.getenv("NACOS_DATA_ID", "nacos-fastapi-mcp-example.yaml")
NACOS_GROUP = os.getenv("NACOS_GROUP", "DEFAULT_GROUP")

# Nacos 注册（NamingService）
SERVICE_NAME = os.getenv("SERVICE_NAME", "nacos-fastapi-mcp-example")
SERVICE_GROUP = os.getenv("SERVICE_GROUP", "DEFAULT_GROUP")
SERVICE_CLUSTER = os.getenv("SERVICE_CLUSTER", "DEFAULT")

MCP_REGISTER_ENABLED = os.getenv("MCP_REGISTER_ENABLED", "true").lower() == "true"
